...
namespace ShopOnline.AdminApp.Services
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public async Task<ApiResult<string>> Authenticate(LoginRequest rq)
        {
            ...
            var x = JsonConvert.DeserializeObject<ApiSuccessResult<string>>(await response.Content.ReadAsStringAsync());
        ...
        public async Task<ApiResult<bool>> RegisterUser(RegisterRequest rq)
        {
            var client = _httpClientFactory.CreateClient();
            client.BaseAddress = new Uri(_configuration["BaseAddress"]);
